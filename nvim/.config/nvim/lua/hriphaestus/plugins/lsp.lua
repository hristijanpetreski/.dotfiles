		...
		config = function()
			vim.api.nvim_create_autocmd("LspAttach", {
				...
				callback = function(event)
					...
					---@param bufnr? integer some lsp support methods only specific files
					---@return boolean
			...
			local tools_and_formatters = {
				"stylua",
				"rubocop",
				"prettier",
			}

			require("mason-tool-installer").setup({ ensure_installed = tools_and_formatters })
